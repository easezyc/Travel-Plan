...
public class ShowArticleImgServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ShowArticleImgServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			pagehelp=service.getArticleImg(page);
		...
		request.getRequestDispatcher("/footmark/showimg.jsp").forward(request,response);
	}
